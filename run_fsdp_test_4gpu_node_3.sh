...
# CONFIGS_DET=("high_frequency_low_intensity_0.2" "high_frequency_low_intensity_0.5" "high_frequency_low_intensity_0.7" "high_frequency_low_intensity_1")
...
# Gradient comparison across all layers — one CSV per RS layer per run
